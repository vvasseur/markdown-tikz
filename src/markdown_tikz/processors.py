...
class HeadingReportingTreeprocessor(Treeprocessor):
    ...
    name = "markdown_tikz_record_headings"
...
class InsertHeadings(Treeprocessor):
    ...
    name = "markdown_tikz_insert_headings"
        ...
        for el in root.iter():
            ...
            if match:
                ...
                if markup in self.headings:
                    div = Element("div", {"class": "markdown-tikz"})
...
class RemoveHeadings(Treeprocessor):
    ...
    name = "markdown_tikz_remove_headings"
    ...
    def run(self, root: Element) -> None:  # noqa: D102
        ...
        for el in reversed(
            ...
            for subel in reversed(el):
                if subel.tag == "div" and subel.get("class") == "markdown-tikz":
